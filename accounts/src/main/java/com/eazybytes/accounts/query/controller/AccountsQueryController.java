...
public class AccountsQueryController {
    ...
    @GetMapping("fetch")
    public ResponseEntity<AccountsDto> fetchAccountsDetails(@RequestParam("mobileNumber") @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits") String mobileNumber) {
