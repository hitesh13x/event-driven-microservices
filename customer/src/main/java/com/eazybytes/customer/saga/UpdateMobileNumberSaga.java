...
public class UpdateMobileNumberSaga {
    ...
    public void handle(AccntMobileNumUpdatedEvent event) {
        log.info("Saga Event 2 [Start] : Received AccntMobileNumUpdatedEvent for AccountNumber: {}", event.getAccountNumber());
    ...
    public void handle(CardMobileNumUpdatedEvent event) {
        log.info("Saga Event 3 [Start] : Received CardMobileNumUpdatedEvent for CardNumber: {}", event.getCardNumber());
    ...
    public void handle(LoanMobileNumUpdatedEvent event) {
        log.info("Saga Event 4 [Start] : Received LoanMobileNumUpdatedEvent for loanId: {}", event.getLoanNumber());
    ...
    public void handle(CusMobNumRollbackedEvent event) {
        log.info("Saga Compensation Event : Received CusMobNumRollbackedEvent for customerId: {}", event.getCustomerId());
        queryUpdateEmitter.emit(FindCustomerQuery.class, query -> true,
