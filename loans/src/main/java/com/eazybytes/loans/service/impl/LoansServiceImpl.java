...
public class LoansServiceImpl implements ILoansService {
    ...
    public void createLoan(Loans loan) {
        Optional<Loans> optionalLoan = loansRepository.findByMobileNumberAndActiveSw(loan.getMobileNumber(),
    ...
    /**
     * @param loanUpdatedEvent - LoansDto Object
     * @return boolean indicating if the update of loan details is successful or not
     */
    @Override
    public boolean updateLoan(LoanUpdatedEvent loanUpdatedEvent) {
        Loans loan = loansRepository.findByMobileNumberAndActiveSw(loanUpdatedEvent.getMobileNumber(),
                LoansConstants.ACTIVE_SW).orElseThrow(
                () -> new ResourceNotFoundException("Loan", "LoanNumber", loanUpdatedEvent.getLoanNumber().toString()));
        LoansMapper.mapToLoans(loanUpdatedEvent, loan);
        loansRepository.save(loan);
        return true;
    }
